...
public sealed class Plugin : IDalamudPlugin
{
    ...
    public Plugin(IDalamudPluginInterface pluginInterface)
    {
        ...
        DalamudUtil = new DalamudUtil();
        IpcManager = new IpcManager(pluginInterface, DalamudUtil, this);
        SnapshotManager = new SnapshotManager(this);
        McdfManager = new McdfManager(this, SnapshotManager);
        PmpManager = new PmpExportManager(this);
    ...
    )
    {
        if (dirsToMigrate.Any())
        {
            ...
            {
                SnapshotMigrator.Migrate(dir, IpcManager);
                migratedCount++;
            }
